...
class My_Excel_Writer
{
	...
	public function export($fileName = "excel",$isConvert=false)
	{
        ...
        echo str_replace("{company}","Fidy",str_replace("{time}",date("Y-m-dH:i:s",time()),str_replace("{author}","Fidy",str_replace("{version}","1.0",$this->documentInfo))));
        echo "<Styles>";
